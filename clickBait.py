"""Clickbait Headline Generator, by Al"""
...
def generateYouWontBelieveHeadline():
    ...
    return 'You Wont\'t Believe What This {} {} Found in {} {}'.format(state, noun, pronoun, place)

    
def generateDontWantYouToKnowHeadline():
    pluralNoun1 = random.choice(NOUNS) + 's'
    pluralNoun2 = random.choice(NOUNS) + 's'
    return 'What {} Dont\'t Want You To Know About {}'.format(pluralNoun1, pluralNoun2)
...
def generateReasonsWhyHeadline():
    ...
    plurarNoun = random.choice(NOUNS) + 's'
    # number2 should be no Larger than number1:
    number2 = random.randint(1, number1)
    return '{} Reasons why {} Are More Intresting Than You Think (Number {} Will Surprise You!)'.format(number1, plurarNoun, number2)
...
def generateJobAutomatedHeadline():
    ...
    if pronoun1 == 'Their':
        return 'This {} {} Didn\'t Thing Robots Would Take {} Job. {} Were Wrong.'.format(state, noun, pronoun1, pronoun2)
    else:
