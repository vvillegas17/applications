'''calendar Maker, by Victor Villegas AKA: V'''
...
def getCalendarFor(year, month):
    ...
    # Put the month and the top of the calendar:
    calText += (' ' * 34) + MONTHS[month - 1] + ' ' + str(year) + '\n'

    # Add the days of the week labels to the calendar:
    # (!) Try changing this to abbreviations: SUN, MON, TUE, etc.
    calText += '...Sunday.....Monday....Tuesday...Wednesday...Thursday....Friday....Saturday../n'

    # The horizontal line string that separate weeks:
    weekSeparator = ('+----------' * 7) + '+\n'

    # The blank rows have ten spaces in bewteen the | day separator:
    blankRow = ('|          ' * 7) + '|\n'
    ...
    # Roll back currentDate until it is Sunday. (weekday) return 6
    # for Sunday, not 0.)
    ...
    while True: # Loop over each week in the month.
        ...
        dayNumberRow += '|\n' # Add the vertiacal line after Saturday.

        # Add the day number row and 3 blank row to the calendar text.
        calText += dayNumberRow
        for i in range(3): # (!) Try changing the 4 to 5 or 10.
            calText += blankRow
    ...
    # Add the horzontal line at the very bottom of the calendar.
    calText += weekSeparator
    return calText
...
calendarFilename = 'calendar_{}){}.txt'.format(year, month)
