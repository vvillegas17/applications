"""Carrot in a Box, by Victor Villegas AKA: V"""
...
print()
print(p1Name + ', say one of the following senctences to ' + p2Name + '.')
print('  1) There is a carrot in the box.')
...
while True:
    ...
    if not (response.startswith('Y') or response.startswith('N')):
        ...
        break
firstBox = 'RED ' # Note the spcae after the "D"
secondBox = 'GOLD'
...
# The modififcation made possible through the 'carrotInFirstBox variable
if carrotInFirstBox:
