print(' bouncing DVD Logo, by Victor Villegas AKA: V')
...
NUMBER_OF_LOGOS = 5 # (!) try changing this 1 or 100. 
...
def main():
    ...
    while True: # Main program loop
        for logo in logos: # Handle each logo in the logos list.
            ...
            # see if he logo bounces off the right edge:
